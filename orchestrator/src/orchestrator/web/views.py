...
_ENUM_OPTIONS = {
    ...
    "server_role": ["target", "loadgen"],
    "baseline_type": ["proxmox", "vsphere", "vultr"],
    "db_type": ["mssql", "postgresql"],
    "disk_type": ["ssd", "hdd"],
    "template_type": ["server-steady", "server-normal", "server-file-heavy", "db-load"],
...
async def admin_scenarios(request: Request):
    return templates.TemplateResponse("admin/scenarios.html", {
        ...
        "labs_api_path": "/api/admin/labs",
        "packages_api_path": "/api/admin/package-groups",
        "columns": [
            {"key": "id", "label": "ID"},
            {"key": "name", "label": "Name"},
            {"key": "lab_id", "label": "Lab", "lookup": "labs"},
            {"key": "template_type", "label": "Template"},
            {"key": "has_dbtest", "label": "DB Test", "type": "bool"},
            {"key": "stress_test_enabled", "label": "Stress", "type": "bool"},
            {"key": "network_degradation_enabled", "label": "Net Degrade", "type": "bool"},
            {"key": "created_at", "label": "Created", "type": "date"},
        ],
        "fields": [
            {"key": "name", "label": "Name", "type": "text", "required": True},
            {"key": "description", "label": "Description", "type": "textarea"},
            {"key": "lab_id", "label": "Lab", "type": "select_dynamic",
             "source": "labs", "required": True},
            ...
            {"key": "load_generator_package_grp_id", "label": "Load Gen Package Group", "type": "select_dynamic",
             "source": "packages", "required": True},
            {"key": "stress_test_enabled", "label": "Stress Test Enabled", "type": "checkbox"},
            {"key": "stress_test_duration_sec", "label": "Stress Duration (s)", "type": "number",
             "depends_on": "stress_test_enabled"},
            {"key": "stress_test_thread_multiplier", "label": "Stress Thread Multiplier", "type": "number",
             "step": "0.1", "depends_on": "stress_test_enabled"},
            {"key": "network_degradation_enabled", "label": "Network Degradation", "type": "checkbox"},
            {"key": "network_degradation_pct", "label": "Degradation %", "type": "number",
             "step": "0.1", "depends_on": "network_degradation_enabled"},
            {"key": "network_degradation_duration_sec", "label": "Degradation Duration (s)", "type": "number",
             "depends_on": "network_degradation_enabled"},
        ],
    })
